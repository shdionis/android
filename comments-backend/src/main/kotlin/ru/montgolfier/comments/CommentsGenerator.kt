...
object CommentsGenerator {
    ...
    private fun generatePage(): Comments = Comments(ArrayList<Comment>().apply {
    ...
    data class Comment(val author: String, val message: String, val rating: Int, val avatar: String)
